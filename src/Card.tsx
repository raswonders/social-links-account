export function Card() {
  return (
    <div className="w-80 p-6 bg-stone-900 rounded-xl flex-col justify-start items-center gap-6 inline-flex">
      <img
      ...
      <div className="self-stretch h-[61px] flex-col justify-start items-center gap-1 flex">
        ...
        <div className="self-stretch text-center text-lime-400 text-sm font-bold font-['Inter'] leading-[21px]">
